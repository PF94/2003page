...
For the deletion of your own subsite, use the internal/public (Windows-only for now) 2003page Subsite Purger. It will automaticly generate the "Retired subsite" error page, and will commit stuff for you... only if there's no Git file conflicks.
