(window.webpackJsonp = window.webpackJsonp || []).push([
  [0],
  {
    1: function (t, e, n) {
      ...
      n(72), n(25);
      var r = n(41),
        o = (n(145), n(146), n(147), n(27)),
        c = (n(94), n(95), n(150), n(152), n(97), n(40), n(5)),
        f = (n(61), n(22), n(13), n(55), n(70), n(26)),
        l = n(0);
      function d(object, t) {
            ...
            for (
              ...
              if ("string" != typeof f) {
                ...
                if (Array.isArray(l)) {
                  ...
                  if (((d = f.asterisk ? M(l, !0) : o(l)), !n[c].test(d)))
                    throw new TypeError(
                      'Expected "' +
                        f.name +
                        '" to match "' +
                  ...
                  function (t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 35:
                          return (
                            "function" == typeof (_ = v[0].options.layout) &&
                              (_ = _(m.context)),
                            (t.next = 39),
                            this.loadLayout(_)
                          );
                        ...
                        case 53:
                          ...
                          if (
                            "function" == typeof (S = P.value).options.validate
                          ) {
                            t.next = 57;
                            break;
                          }
        ...
        routes: [
          {
            path: "/",
            component: function () {
              return Object(x.j)(n.e(2).then(n.bind(null, 194)));
            },
            name: "index",
          },
        ],
      ...
      var O,
        ...
        D =
          ...
          n(162),
          {
            ...
            data: function () {
              return { shouldRotate: !1, show: !0, showInfo: !1 };
            },
            created: function () {
              this.animatedBorder();
            },
                                ...
                                t.showInfo
                                  ? n(
                                      ...
                                      [
                                        n("h3", [
                                          t._v(
                                            "MSCHF Drop #" + t._s(t.dropNumber)
                                          ),
                                        ]),
                                        t._v(" "),
                                        n("h1", [t._v(t._s(t.dropName))]),
                                        t._v(" "),
                                        n("h2", [t._v(t._s(t.dropTagline))]),
                                      ]
                                    )
                                  : t._e(),
                              ]),
          ...
          head: {
            ...
            meta: [
              ...
              },
              {
                name: "keywords",
                content:
                  "mschf, zuckerberg, facebook, privacy, 2525, social media, plutocracy, spying",
              },
              { name: "author", content: "mschf" },
              { name: "twitter:title", content: "Zuckwatch" },
              ...
              },
              {
                ...
                content: "https://zuckwatch.com/sharecard.png",
              },
              { property: "og:title", content: "Zuckwatch" },
              { property: "og:url", content: "https://zuckwatch.com" },
              {
                property: "og:image",
                content: "https://zuckwatch.com/sharecard.png",
              },
              ...
              { property: "og:site_name", content: "Zuckwatch" },
            ],
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 4:
                        r.id = t.sent;
                      case 5:
                        c.a.use(F.a, B({}, { router: e.app.router }, {}, r)),
                          (e.$ga = c.a.$ga),
                          n("ga", c.a.$ga);
                      case 8:
                      case "end":
        ...
        tt = function (t) {
          ...
          t.onRequest(function (t) {
            ...
            t.onError(function (t) {
              (t && t.config && !1 === t.config.progress) ||
                (r--, Z.a.isCancel(t) || (n().fail(), n().finish()));
            });
          var o = function (t) {
            if (r) {
              ...
              for (;;)
                switch ((t.prev = t.next)) {
                  ...
                  case 8:
                    ...
                    return (t.next = 12), U(r.context, l);
                  case 12:
                    return (t.next = 15), et(r.context, l);
                  case 15:
                    t.next = 18;
                    break;
                  case 18:
    ...
    166: function (t, e, n) {
      ...
      e.push([
        t.i,
        "@font-face{font-family:Andale Mono;src:url(" +
          f +
          ")}#MSCHFPreloader[data-v-4a4ee5f7]{background:#000;position:fixed;height:100%;width:100%;display:-webkit-box;display:flex;-webkit-box-align:center;align-items:center;-webkit-box-pack:center;justify-content:center;top:0;z-index:99}#MSCHFPreloader .gradient-background[data-v-4a4ee5f7]{background:#18a7e5;background:-webkit-gradient(linear,left top,left bottom,from(#18a7e5),color-stop(35%,#18a7e5),color-stop(60.5%,#ff0400),color-stop(60.5%,#ffc800),to(#ffc800));background:linear-gradient(180deg,#18a7e5,#18a7e5 35%,#ff0400 60.5%,#ffc800 0,#ffc800);width:300%;height:300%;-webkit-transition:all 1.5s;transition:all 1.5s;opacity:0;-webkit-transform-origin:center center;transform-origin:center center;position:absolute}#MSCHFPreloader .gradient-background.rotate[data-v-4a4ee5f7]{opacity:1;-webkit-transform:rotate(180deg);transform:rotate(180deg);-webkit-transition-timing-function:ease-out;transition-timing-function:ease-out}#MSCHFPreloader .loader-inner[data-v-4a4ee5f7]{background:#000;width:calc(100% - 22px);height:calc(100% - 22px);position:absolute;z-index:9;text-transform:uppercase;display:-webkit-box;display:flex;-webkit-box-align:center;align-items:center;-webkit-box-pack:center;justify-content:center;-webkit-box-orient:vertical;-webkit-box-direction:normal;flex-direction:column;color:#fff}#MSCHFPreloader .loader-inner .content-wrapper[data-v-4a4ee5f7]{text-align:center;width:70vw;max-width:100%}#MSCHFPreloader .loader-inner .content-wrapper h1[data-v-4a4ee5f7],#MSCHFPreloader .loader-inner .content-wrapper h2[data-v-4a4ee5f7],#MSCHFPreloader .loader-inner .content-wrapper h3[data-v-4a4ee5f7]{font-family:Andale Mono;line-height:1.75rem;font-size:1.5rem}#MSCHFPreloader .loader-inner .content-wrapper h1[data-v-4a4ee5f7]{color:#ff0400}.fade-enter-active[data-v-4a4ee5f7],.fade-leave-active[data-v-4a4ee5f7]{-webkit-transition:opacity 1s;transition:opacity 1s}.fade-enter[data-v-4a4ee5f7],.fade-leave-to[data-v-4a4ee5f7]{opacity:0}",
        "",
      ]),
        (t.exports = e);
    },
    167: function (t, e, n) {
      t.exports = n.p + "fonts/9faaf13.ttf";
    },
    168: function (t, e, n) {
      "use strict";
      var r = n(59);
    ...
    58: function (t, e, n) {
      ...
      "string" == typeof content && (content = [[t.i, content, ""]]),
        content.locals && (t.exports = content.locals);
      (0, n(30).default)("9f714a30", content, !0, { sourceMap: !1 });
    },
    59: function (t, e, n) {
      var content = n(169);
      "string" == typeof content && (content = [[t.i, content, ""]]),
        content.locals && (t.exports = content.locals);
      (0, n(30).default)("932a8f60", content, !0, { sourceMap: !1 });
    },
    60: function (t, e, n) {
      "use strict";
      n(13), n(66), n(25), n(22), n(84), n(86);
      var r = n(0),
        o =
