...
!(function (t, e) {
  ...
  U.on(
    ...
    U.on(document, "click.bs.dropdown.data-api", ".dropdown form", function (
      t
    ) {
  ...
  U.on(document, "click.bs.modal.data-api", '[data-toggle="modal"]', function (
    t
  ) {
    var e = this,
      i = u(this);
